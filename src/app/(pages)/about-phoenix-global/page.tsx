        ...
        <>
            <section id="about-banner" className="grid [&>*]:[grid-area:1/1] place-items-center">
                ...
                <div className="container z-20 pt-16 px-4 grid gap-4 mt-16 text-white">
                    <h1 className="text-3xl lg:text-5xl text-orange-600">Discover the World of Phoenix Global</h1>
                    <p>
                        ...
                        <BreadcrumbList className="text-white">
                            <BreadcrumbItem>
                                <BreadcrumbLink asChild>
                                    <Link href="/" className="text-slate-400 hover:underline hover:underline-offset-2">
                                        Home
                                    </Link>
                                </BreadcrumbLink>
                            </BreadcrumbItem>
            ...
            <section id="about-content" className="px-2 py-8 lg:py-16">
                <div className="container flex gap-4 flex-col lg:flex-row [&>*]:w-full lg:[&>*]:w-1/2">
                    ...
                    <div className="flex flex-col gap-4  mt-8 lg:mt-0">
                        <h2 className="text-[clamp(1.875rem,2.5vw,3rem)] text-balance">Welcome to Phoenix Global</h2>
            ...
            <section id="about-vision-mission" className="px-2">
                <div className="container [&>p]:max-w-[80ch] text-pretty pb-8">
                    ...
                    <p>
                        ...
                        having previously worked with industry leaders such as L&T and Raychem RPG.
                    </p>
